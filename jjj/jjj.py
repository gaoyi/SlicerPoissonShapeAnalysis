...
class jjj(ScriptedLoadableModule):
...
def registerSampleData():
  ...
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    ...
    thumbnailFileName=os.path.join(iconsPath, 'jjj1.png'),
  ...
  SampleData.SampleDataLogic.registerCustomSampleDataSource(
    ...
    category='jjj',
    sampleName='jjj2',
    thumbnailFileName=os.path.join(iconsPath, 'jjj2.png'),
    # Download URL and target file name
...
class jjjWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def setup(self):
    ...
    uiWidget = slicer.util.loadUI(self.resourcePath('UI/jjj.ui'))
    ...
    self.ui.doRegistrationCheckBox.connect("toggled(bool)", self.updateParameterNodeFromGUI)
    #self.ui.invertedOutputSelector.connect("currentNodeChanged(vtkMRMLNode*)", self.updateParameterNodeFromGUI)

    # Buttons
    # self.ui.applyButton.connect('clicked(bool)', self.onApplyButton)

    self.ui.selectButton1.connect('clicked(bool)', self.onSelectButton1)
    self.ui.selectButton2.connect('clicked(bool)', self.onSelectButton2)
  ...
  def updateGUIFromParameterNode(self, caller=None, event=None):
    ...
    self.ui.doRegistrationCheckBox.checked = (self._parameterNode.GetParameter("Register") == "true")
  ...
  def updateParameterNodeFromGUI(self, caller=None, event=None):
    ...
    self._parameterNode.SetParameter("Register", "true" if self.ui.doRegistrationCheckBox.checked else "false")
...
class jjjLogic(ScriptedLoadableModuleLogic):
...
class jjjTest(ScriptedLoadableModuleTest):
  """
  ...
  def test_jjj1(self):
    ...
    import SampleData
    registerSampleData()
    inputVolume = SampleData.downloadSample('jjj1')
